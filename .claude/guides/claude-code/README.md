...
The setup includes:
- **22 skill directories** covering all SDK features
- **14 specialized agents** for different task types
- **8 automation hooks** for quality enforcement
- **9 slash commands** for quick access to knowledge
- **5 rule files** for behavioral constraints
