    ...
    <div className="flex flex-wrap items-end gap-3">
      ...
      <div className="flex flex-col gap-1">
        ...
        <select
          ...
          className="h-8 min-w-[180px] rounded-control border border-border bg-bg-elevated px-2.5 text-body-default text-text-primary focus:border-accent-ring focus:outline-none"
        >
      ...
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          className="h-8 rounded-control border border-border bg-bg-elevated px-2.5 text-body-default text-text-primary focus:border-accent-ring focus:outline-none"
        />
      </div>
      <div className="flex flex-col gap-1">
        <label className="text-[11px] uppercase tracking-wider text-text-faint">
      ...
      <div className="flex gap-2">
        <button
          onClick={onApply}
          className="h-8 rounded-control bg-accent px-4 text-body-default font-medium text-bg-base transition-opacity hover:opacity-90"
        >
          Apply
        </button>
        <button
          onClick={onClear}
          className="h-8 rounded-control border border-border px-4 text-body-default text-text-muted transition-colors hover:border-accent-ring hover:text-text-primary"
        >
          Clear
        </button>
      </div>
