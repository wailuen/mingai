...
export function BYOLLMTab({ config, plan }: BYOLLMTabProps) {
  ...
  return (
    <div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-control border border-border bg-bg-elevated px-3 py-2 pr-10 font-mono text-body-default text-text-primary placeholder:text-text-faint transition-colors focus:border-accent focus:outline-none"
            />
            <button
              type="button"
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          {config.byollm.key_present && (
            <button
              ...
              className="flex items-center gap-1 rounded-control border border-border px-3 py-2 text-body-default text-alert transition-colors hover:bg-alert-dim"
            >
              <Trash2 size={14} />
              Remove Key
            </button>
      ...
      {updateBYOLLM.error && (
        <p className="mt-3 text-body-default text-alert">{updateBYOLLM.error.message}</p>
      )}
          ...
          <div className="mx-4 w-full max-w-md rounded-card border border-border bg-bg-surface p-6">
            ...
            <div className="mt-5 flex items-center justify-end gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-control bg-alert px-4 py-1.5 text-body-default font-semibold text-white transition-opacity hover:opacity-90 disabled:opacity-40"
              >
