...
export default function AgentsPage() {
  const [activeTab, setActiveTab] = useState<TabId>("my-agents");
            ...
            {!isPending && agents.length === 0 && !error && (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                <p className="text-body-default text-text-faint">
                  No agents deployed yet. Browse the Agent Library to deploy
                  templates.
                </p>
                <button
                  type="button"
                  onClick={() => setActiveTab("library")}
                  className="mt-3 text-body-default text-accent hover:underline"
                >
