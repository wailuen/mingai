        ...
        <table className="min-w-full">
          ...
          <tbody>
            {(["chat", "intent", "vision", "agent"] as const).map((slot) => {
              ...
              const isEnterpriseGated = ENTERPRISE_SLOTS.includes(slot);
              return (
                  ...
                  <td className="px-4 py-3">
                    {isEnterpriseGated ? (
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className="rounded-badge bg-bg-elevated px-2 py-0.5 text-[10px] text-text-faint"
                          title="Upgrade to Enterprise to configure these slots"
                        >
                          Enterprise
                        </span>
                      </div>
