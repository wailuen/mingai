...
DEFAULT_TTL: dict[str, int] = {
    ...
    "intent": 86_400,  # 24 h — CACHE-001: long-lived intent cache
    "query_cache": 3_600,  # 1 h — short-lived query responses
    "search": 3_600,  # 1 h — CACHE-003: search result cache
    "emb": 604_800,  # 7 days — CACHE-002: float16 embedding cache
