...
| `04-llm-models-reference.md` | All LLM models and AI services to configure in the LLM Library — providers, credentials, migration hints, Bedrock/Ollama model names                                                                                                                                                                                                                                                                                                                                 | Configuring LLM Library entries |
