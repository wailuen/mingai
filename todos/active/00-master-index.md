...
| `todos/active/04-platform-admin-phase-b-d.md` | PA health scoring, cost monitoring, templates, tool catalog  | 36 (PA-001–036)     | 34/36 COMPLETED (PA-002, PA-004–PA-036); PA-001 and PA-003 remain TODO (frontend items)         |
| `todos/active/05-tenant-admin-phase-b-d.md`   | SSO wiring, access control, agent workspace, mobile          | 36 (TA-001–036)     | 14/36 COMPLETED (TA-015, TA-017–024, TA-026–030); TA-025 BLOCKED (product gate); remainder TODO |
