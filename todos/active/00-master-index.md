...
| `todos/active/08-llm-provider-config.md`         | Platform LLM provider credential management — DB-backed, no .env | 20 (PVDR-001–020)   | 0/20 — NEW (2026-03-17). Unblocked. Prerequisite for eliminating AZURE*PLATFORM_OPENAI*\* env vars.                                            |
