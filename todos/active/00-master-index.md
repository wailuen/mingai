...
| --------------------------------------------- | ------------------------------------------------------------ | ------------------- | ------------------------------------------------------------ |
| `todos/active/01-phase2-llm-library.md`       | LLM abstraction layer, multi-provider support, cost tracking | 20 (P2LLM-001–020)  | 19/20 COMPLETED; P2LLM-020 TODO (E2E — frontend deploy gate) |
...
| `todos/active/03-caching-c2-c4.md`            | Pipeline caches, semantic cache (pgvector), cache analytics  | 19 (CACHE-001–019)  | CACHE-007 COMPLETED; 18 TODO                                 |
...
19 of 20 P2LLM items complete. CACHE-007 complete. Items remain in their active files with COMPLETED status and evidence annotations.
...
| `todos/active/03-caching-c2-c4.md`      | CACHE-007                   | 1     | `alembic/versions/v011_semantic_cache.py` — pgvector extension, HNSW index (m=16, ef_construction=64), RLS policies. Unblocks DEF-013.                     |

**Remaining in 01-phase2-llm-library.md**: P2LLM-020 (E2E Playwright tests) — blocked on frontend deployment. File stays in `active/` until P2LLM-020 is complete.
