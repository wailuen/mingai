...
| `todos/active/07-deferred-phase1.md`             | Phase 1 deferred items — now actionable with Phase 2             | 20 (DEF-001–020)    | 17/20 COMPLETED (DEF-001–005, DEF-007–011, DEF-013–014, DEF-016–019); DEF-006/020 GATED; DEF-015 TODO (Auth0 CI secrets required)              |
| `todos/active/08-llm-provider-config.md`         | Platform LLM provider credential management — DB-backed, no .env | 20 (PVDR-001–020)   | ✅ ALL 20 COMPLETED — 2026-03-17 (Session 38). 2538 unit tests passing.                                                                        |
