...
1. Was looking through user flow:
a. Many flow still refer to MCP Servers. We only support A2A agents conbfiguration, not direct MCP servers. Refer to product documentation
b. Do review all document to ensure it is consistent with all the decision and changes made.
