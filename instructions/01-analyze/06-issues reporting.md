...
1. Allow application user to report system bugs/issues/improvement. Capture screen print along with the issue
2. This intent is to capture the issue, platform agent would evaluate and create issue in repo, schedule fix and report back to user on the fixes.

3. Document in details, your work in `workspaces/<project-directory>/01-analysis/01-research`.
