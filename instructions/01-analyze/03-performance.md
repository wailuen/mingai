...
1. You need to ensure best response to end user. Evaluate the optimum usable of caching in the entire chain of event leading from user query to response. 
...
3. Review existing Document in details and ensure that for each details are in `workspaces/<project-directory>/01-analysis/01-research`.
   - Use as many subdirectories and files as required
   - Name them sequentially as 01-, 02-, etc, for easy referencing
